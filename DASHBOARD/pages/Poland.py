...
def cartas_jugador_manual(name,link_img,cod_img,posicion):
    ...
    return card
def cartas_jugador_dominguez(name,cod_img,posicion):
    card = html.Div([
    html.Button([
    html.Div(
        [html.P(posicion)],className='text_pos'
...
layout = html.Div([
    ...
    html.Div([
        ...
        cartas_jugador_polonia(players.Jugador[13],cod_img,players.Posición[13]),
        ...
        cartas_jugador_polonia(players.Jugador[16],cod_img,players.Posición[16]),
        ...
        cartas_jugador_dominguez(players.Jugador[19],cod_img,players.Posición[19]),
        ...
        cartas_jugador_dominguez(players.Jugador[22],cod_img,players.Posición[22]),
        ...
        cartas_jugador_polonia(players.Jugador[26],cod_img,players.Posición[26]),
