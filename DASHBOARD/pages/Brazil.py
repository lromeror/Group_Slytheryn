...
layout = html.Div([
    ...
    html.Div([
        cartas_jugador_manual(players.Jugador[0],'assets/Images/Brazil/Alisson.png',cod_img,players.Posición[0]),
        cartas_jugador_manual(players.Jugador[1],'assets/Images/Brazil/Éderson.png',cod_img,players.Posición[1]),
