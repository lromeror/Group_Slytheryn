...
layout = html.Div([
    ...
    html.Div([
        ...
        cartas_jugador_dominguez(players.Jugador[4],cod_img,players.Posición[4]),
        ...
        cartas_jugador_dominguez(players.Jugador[14],cod_img,players.Posición[14]),
        ...
        cartas_jugador_dominguez(players.Jugador[26],cod_img,players.Posición[26]),
