...
df_img_codes = pd.read_csv('/Users/angelozurita/Repositorios_GitHub/Group_Slytheryn/DASHBOARD/assets/Renombrar - jonathan.csv',sep=';')
for pais in  ['Germany','Costa Rica','Croatia','Iran','Denmark','Poland','Switzerland']:
