...
df_img_codes = pd.read_excel('/Users/angelozurita/Repositorios_GitHub/Group_Slytheryn/Data_worldCup/Los ultimos.xlsx',sheet_name='Hoja1')
for pais in  ['France','Ghana','Netherlands']:
